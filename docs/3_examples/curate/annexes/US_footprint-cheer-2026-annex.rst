...
* **Secondary datasets**: Downloads the National Structure Inventory (NSI) 2022 point database (``US_building-nsi-2022``), Overture 2025 dwelling address points (``dwelling-overture-2025``), and FEMA USA Structures footprints (``US_footprint-fema-2023``, used for parcel-aggregated occupancy evidence, not as a footprint geometry source).
