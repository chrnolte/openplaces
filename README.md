...
- Utilities for impact evaluation, property value estimation, conservation planning, and hedonic valuation.
- Cloud / cluster-friendly workflows for scalability and reproducibility in defense of replicable science.
- Globally consistent data referencing to support international comparative research.
- Modern Python stack (`geopandas`, `rasterio`, `xarray`, `scikit-learn`).
