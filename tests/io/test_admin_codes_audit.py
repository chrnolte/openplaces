...
class TestResolveIdentifier:
    ...
    def test_a_recycled_identifier_follows_the_unit_not_the_string(self):
        ...
        resolved = resolve_identifier('US-NC-HD')
        assert name_by_id[resolved] == 'Hyde'
        assert name_by_id['US-NC-HD'] != 'Hyde', (
